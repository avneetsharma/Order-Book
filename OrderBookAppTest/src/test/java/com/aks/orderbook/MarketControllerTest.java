...
import com.aks.orderbook.OrderItemDao;
...
public class MarketControllerTest {
    ...
    public void addMarketItem() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/marketItem").content(asJsonString("name"))
    ...
    @Test
    public void addOder() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/order/add")
                ...
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("success: order added.")));
    }
